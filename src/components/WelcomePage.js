  ...
  return (
    <div className="welcome-container">
      ...
      <ul>
        <li>
          <p>
            To add a new todo to your list just simply write your text that you
            would like in the todo in the input box and press the plus button.
          </p>
        ...
        <li>
          <p>
            Todo List also lets you associate your todos with four colors: blue,
            green, yellow and red. Its up to you how you choose to use this
            feature but here are some suggestions.{" "}
          </p>
          <p>
          ...
          <p>
            3. Think of individual colors as urgency to tell you how quickly you
            should finish what todos.
          </p>
          <video width="852" height="580" autoPlay muted loop>
            <source src={video} type="video/mp4" />
            Your browser does not support the video tag.
